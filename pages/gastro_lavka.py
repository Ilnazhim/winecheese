...
class GastroPage(BaseClass):

    # Locators
    ask_gastro_forma = "//span[@class='PageFooter_footer__link__2yvLx']"
    ...
    def get_ask_gastro_forma(self):
        return WebDriverWait(self.browser, 30).until(EC.element_to_be_clickable((By.XPATH, self.ask_gastro_forma)))
    ...
    def click_gastro_forma(self):
        self.get_ask_gastro_forma().click()
        print("Click ask_gastro_forma")
    ...
    def input_name_fio_ask_gastro(self):
        self.get_name_fio().send_keys(*DataPage.fio_ask_gastro)
        print("input name_fio_ask_gastro")
    ...
    # Metods
    def fill_ask_gastro_forma(self):
        """Fill ask_gastro_forma"""
        # with allure.step("select_products_1"):
        Logger.add_start_step(method="gastro ask forma")

        self.get_current_url()
        self.click_gastro_forma()
        self.input_name_fio_ask_gastro()
        self.input_phone()
        self.input_telegram()
        ...
        Logger.add_end_step(url=self.browser.current_url, method="gastro ask forma")
